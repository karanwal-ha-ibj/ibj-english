  ...
  return (
    <div>
      <div>
        <div className="main-bg">
          <div className="home-wrapper2">
            ...
            <div className="item2">
              <img style={{width:"20px", marginTop:"17px"}} src={arrow} alt=""></img>
        ...
        <div className="newsletter-main">
          ...
          <div className="newsletter-wrapper">
            ...
            <button type="submit" className="newsletter-button"><img src={thinarrow} style={{width:"30px"}} alt=""></img></button>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="ceo-subdiv">
              ...
              <div className="ceo-subsubdiv">
                <p className="ceo-text1">Innovation and tireless effort towards growing<br /> the marriage-hunting market</p>
                <p className="ceo-text2">President & CEO<br /><span style={{color: "#00478c", fontWeight:"700"}}>Shigeru Ishizaka</span></p>
              </div>
              <div className="ceo-image-div">
                <img className="ceo-image" src="https://www.ibjapan.jp/information/wp-content/uploads/2023/06/message.jpg" alt="" />
              </div>
              </div>
          </div>
        </div>
          ...
          <div className="services-wrapper">
            ...
            <div style={{display:"flex"}}>
              ...
              <div>
                ...
                <p style={{color:"#01abd0", fontWeight:"700"}}>(in Japanese)</p>
              </div>
      ...
      <div className="news">
        ...
        <div style={{display:"flex", alignItems:"end", gap:"10px", marginTop:"-30px"}}>
          <a className="news-subheadng" href="https://www.ibj-gl.com/wp-content/uploads/2024/03/%E8%8B%B1%E8%A8%B3%E7%89%88%E6%8B%9B%E9%9B%86%E9%80%9A%E7%9F%A5_240228.pdf" target="_blank" rel="noopener noreferrer">✱ Notice of Convocation of the 18th Annual General Meeting of Shareholders</a>
        ...
        <div style={{display:"flex", alignItems:"end", gap:"10px", marginTop:"-30px"}}>
          <a className="news-subheadng" href="https://www.ibj-gl.com/wp-content/themes/ibj-gl-wp/img/ir/ir_pdf/Medium-Term_ManagementPlan/mtmp_2023-2027.pdf" target="_blank" rel="noopener noreferrer"> ✱ MediumTerm-ManagementPlan</a>
          <img src={pdf} alt="" style={{ width: "20px" }} />
        </div>
        <div className="news-line"/>
        ...
        <div style={{display:"flex", alignItems:"end", gap:"10px", marginTop:"-30px"}}>
          <a className="news-subheadng" href="https://www.ibj-gl.com/wp-content/themes/ibj-gl-wp/img/ir/ir_pdf/FinancialResultsBriefingData/2024/Full-year_for_the_Fiscal_Year_Ended_December-31-2023.pdf" target="_blank" rel="noopener noreferrer"> ✱ 2023 4Q Financial Results</a>
          <img src={pdf} alt="" style={{ width: "20px" }} />
        </div>
        <div className="news-line"/>
        ...
        <div style={{display:"flex", alignItems:"end", gap:"10px", marginTop:"-30px"}}>
          <a className="news-subheadng" href="https://www.ibj-gl.com/wp-content/themes/ibj-gl-wp/img/ir/ir_pdf/FinancialResultsBriefingData/2023/fr_2023-Q3.pdf" target="_blank" rel="noopener noreferrer"> ✱ 2023 3Q Financial Results</a>
          <img src={pdf} alt="" style={{ width: "20px" }} />
        </div>
        <div className="news-line"/>
        ...
        <p className="news-heading">November 10th, 2023</p>
        <div style={{display:"flex", alignItems:"end", gap:"10px", marginTop:"-30px"}}>
          <a className="news-subheadng" href="https://www.ibj-gl.com/wp-content/themes/ibj-gl-wp/img/ir/ir_pdf/Flash-Reports/2023/fl_2023-Q3.pdf" target="_blank" rel="noopener noreferrer"> ✱ 2023 3Q Financial Statements</a>
          <img src={pdf} alt="" style={{ width: "20px" }} />
        </div>
        <div className="news-line"/>
        ...
        <div style={{display:"flex", alignItems:"end", gap:"10px", marginTop:"-30px"}}>
          <a className="news-subheadng" href="https://www.ibj-gl.com/wp-content/themes/ibj-gl-wp/img/ir/ir_pdf/FinancialResultsBriefingData/2023/fr_2023-Q2.pdf" target="_blank" rel="noopener noreferrer"> ✱ 2023 2Q Financial Results</a>
          <img src={pdf} alt="" style={{ width: "20px" }} />
        </div>
        <div className="news-line"/>
        ...
        <p className="news-heading">August 10th, 2023</p>
        <div style={{display:"flex", alignItems:"end", gap:"10px", marginTop:"-30px"}}>
          <a className="news-subheadng" href="https://www.ibj-gl.com/wp-content/themes/ibj-gl-wp/img/ir/ir_pdf/Flash-Reports/2023/fl_2023-Q2.pdf" target="_blank" rel="noopener noreferrer"> ✱ 2023 2Q Financial Statements</a>
          <img src={pdf} alt="" style={{ width: "20px" }} />
        </div>
        <div className="news-line"/>
        ...
        <div style={{display:"flex", alignItems:"end", gap:"10px", marginTop:"-30px"}}>
          <a className="news-subheadng" href="https://www.ibj-gl.com/wp-content/themes/ibj-gl-wp/img/ir/ir_pdf/OrdinaryGeneralMeeting-of-Shareholders/Notice_of_Convocation_of_the_17th_Annual_General_Meeting_of_Shareholders.pdf" target="_blank" rel="noopener noreferrer"> ✱ Ordinary General-MeetingShareholders</a>
          <img src={pdf} alt="" style={{ width: "20px" }} />
        </div>
        <div className="news-line"/>
      </div>
